//
//  MeTrjectoryViewControllerTableViewCell.m
//  KaKa
//
...
#import "MyTools.h"
@implementation MeTrajectoryViewControllerTableViewCell

+(instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"cell";
    MeTrajectoryViewControllerTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    tableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    if (cell == nil)
    {
        cell = [[MeTrajectoryViewControllerTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
...
{
    frame.size.height -= 28*PSDSCALE_Y;
