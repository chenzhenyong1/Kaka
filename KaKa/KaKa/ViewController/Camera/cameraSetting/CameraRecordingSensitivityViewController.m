//
//  CameraRecordingSensitivityViewController.m
//  KaKa
//
...
@interface CameraRecordingSensitivityViewController ()

@property (nonatomic, strong) UIButton *selectedRadioBtn;
@end

@implementation CameraRecordingSensitivityViewController
...
//    // 提示
//    [self labelWithFrame:CGRectMake(15, y + 15, SCREEN_WIDTH - 15, 32 * PSDSCALE_Y) inView:self.view textColor:RGBSTRING(@"777777") fontSize:FONTCALE_Y * 25 text:@"数值越大越高。" alignment:NSTextAlignmentLeft bold:NO fit:NO];
}
...
- (void)socketWithBody:(NSString *)body
{
        ...
        msg.msgBody = [NSString stringWithFormat:@"cdrSystemCfg.volumeRecordingSensitivity=\"%@\"",body];
